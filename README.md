crzx evs# Tic Tac Toe CLI: Adding Player Movement to the Game Board
...
1. Our program should first welcome the player by outputting a friendly message to the terminal: " ".
